    ...
    return (
        <div className="bg-black border border-white/10 p-6 relative shadow-lg">
            ...
            <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
                ...
                <div>
                    <span className="text-[9px] font-mono text-purple-800 uppercase tracking-widest block mb-0.5">VĚTVENÍ_PŘÍBĚHU</span>
                    <h3 className="text-xl font-display font-black uppercase tracking-widest text-white">Editor Dilemmatu</h3>
                </div>
            </div>
            ...
            <div className="mb-6 p-4 bg-zinc-900/30 border-l-2 border-purple-500 flex items-center justify-between">
                <div className="flex flex-col">
                    <span className="text-[10px] font-black text-purple-400 uppercase tracking-widest mb-1">ROZSAH ROZHODNUTÍ</span>
                    <span className="text-[9px] text-zinc-500 font-mono">Vyberte cílovou validaci publika</span>
                </div>
                <div className="flex gap-1">
                    ...
                    >
                        <Globe className="w-3 h-3" /> Globální
                    </button>
                </div>
            </div>
                    ...
                    <div key={idx} className="bg-black border border-purple-500/20 hover:border-purple-500/50 transition-colors relative group">
                        ...
                        <div className="bg-purple-950/10 p-3 border-b border-purple-500/10 flex justify-between items-center">
                            <div className="flex items-center gap-3 w-full">
                                <span className="text-[9px] font-mono font-bold text-purple-500 bg-black px-2 py-1 border border-purple-900">MOŽ_0{idx + 1}</span>
                                <input
                                    value={opt.label}
                        ...
                        <div className="p-4 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className={`space-y-3 transition-opacity ${opt.successChance === 100 ? 'opacity-30 pointer-events-none' : 'opacity-100'}`}>
                                    ...
                                    <div className="flex items-center justify-between bg-red-950/10 p-2 border border-red-900/20">
                                        <label className="text-[9px] text-red-400 uppercase font-bold">POSTIH POŠKOZENÍM:</label>
                                        <input
                                            type="number"
                            ...
                            <div className="pt-4 border-t border-zinc-800/50">
                                <label className="text-[9px] font-black text-yellow-600 uppercase tracking-widest block mb-2">AKCE_NA_DESCE (VOLITELNÉ)</label>
